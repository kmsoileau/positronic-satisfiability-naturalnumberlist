...
public class NaturalNumberListSorter extends MetaProblem implements IProblem
{
  ...
  public NaturalNumberListSorter(INaturalNumberList source, INaturalNumberList target) throws Exception
  {
	  ...
	  //The source and target NaturalNumberLists must have exactly the same elements:
